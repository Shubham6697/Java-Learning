...
public class ArrayListExample {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.print("Iterating over ArrayList via iterator: ");
        while(it.hasNext())
        {
        ...
        //for each
        System.out.println();
        System.out.print("Iterating over ArrayList via foreach: ");
        arrayList.forEach((String fruit) -> System.out.print(fruit + " "));
    }
}
